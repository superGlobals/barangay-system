...
$id = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
    ...
    $query = $conn->prepare("SELECT * FROM resident LEFT JOIN purok ON purok.purok = resident.purok WHERE purok_id =:id AND voters_status = 'no' ");
...
@import url('http://fonts.cdnfonts.com/css/bookman-old-style');
 ...
 <main id="main" class="main">
    <div class="pagetitle">
      <h1>Resident Non Voter's List in <?= $purok ?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item active">Resident Non Voter's List in <?= $purok ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
