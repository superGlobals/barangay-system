...
@import url('http://fonts.cdnfonts.com/css/bookman-old-style');
 ...
 <main id="main" class="main">
    ...
    <section class="section">
            ...
            <div class="card-header" style="border: none;">
              ...
              <div class="row mt-2 justify-content-center">
                <div class="col-10">
                    ...
                    <h5 class="mt-3 fw-normal" style="text-align: justify; text-justify: inter-word; text-indent: 80px; font-family: 'Baskervville', serif; color: black;">This is to certify thata resident of <?= ucwords($resident['purok'].", ".$resident['brgy'].", ".$resident['city'].", ".$resident['province']) ?> is known to me personally to belong to one of the <b>INDIGENT FAMILIES</b> in BarangaySto Tomas. Said person needs assistance for the following reason(s).</h5>
                    ...
                    <h5 contenteditable="true" class="mt-3 fw-normal" style="text-indent: 80px; font-family: 'Baskervville', serif; color: black;">Any assistance given to the bearer/relative(s) will be highly appreciated by the undersigned. Issued this <?= date('F j, Y') ?> at Sto. Tomas Peñaranda, Nueva Ecija.</h5>
      ...
      <?php if($bayad['indigency_price'] == 0): ?>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="functions/indigency_payment.php" >
                                <div class="form-group">
                                <label><i class="fa-solid fa-wallet"></i> Payment Per copy is <i class="fa-solid fa-peso-sign"></i><?php echo $bayad['indigency_price'] ?></label>
                                <input type="hidden" class="form-control" name="amount" value="<?php echo $bayad['indigency_price'] ?>">
                                </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="brgyIndigency" class="btn btn-primary">Save</button>
                        </div>
                        </form>
                    </div>
                </div>
