...
@import url('http://fonts.cdnfonts.com/css/bookman-old-style');
 ...
 <main id="main" class="main">
    <div class="pagetitle">
      <h1>Brgy. Certificate</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item active">Brgy. Certificate</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                      ...
                      <div class="text-center">
                          ...
                          <h3 style="color: black; font-size: 20px;" class="mb-0 text-uppercase">TANGGAPAN NG PUNONG BARANGAY</i></h3>     
                             ...
                             <img src="<?php echo $brgy_info['brgy_logo'] ?>" class="img-fluid" width="120">
                                ...
                                <img class="watermark" src="<?= $brgy_info['brgy_logo'] ?>" style="    position: absolute;
                                    top: 180px;
                                    left: 0;
                                    bottom: 0;
                                    right: 0;
                                    ...
                                    <div class="row mt-2" style="border:4px solid black; margin: 0px; border-radius: 10px;">
                                        ...
                                        <div class="col-8" >
                                            ...
                                            <p id="editor" class="mt-3 fw-bold" style="font-family: 'Times New Roman', sans-serif; text-indent: 40px; color: black; font-size: 15;">This is to certify that <span class="fw-bold" style="font-size:15px;"><?= ucwords($resident['firstname'].' '.$resident['middlename'].'. '.$resident['lastname'] .' '. $resident['age']) ?></span>is a bonafide resident of Purok 8 Barangay Sto. Tomas, Peñaranda, Nueva Ecija. has no derogatory record on file.
                                           </p>
                                            <p class="mt-3 fw-bold" style="font-family: 'Times New Roman', sans-serif; text-indent: 40px; color: black; font-size: 15;">This certification is being issued upon the request of the above named for:.</p>
                                           
                                            <div style="text-indent: 40px" class="mb-0">
                                            <h5 class="text-uppercase" style="font-family: 'Berlin Sans FB Demi', sans-serif;
                                         font-weight: bold; color: black; font-size: 11px;">(  ) Tax Declaration</h5>
                                            <h5 class="text-uppercase" style=" font-family: 'Berlin Sans FB Demi', sans-serif;
                                                 font-weight: bold; color: black; font-size: 11px;">(/ ) Any legal purpose this may serve</h5>
                                            <h5 class="text-uppercase" style="font-family: 'Berlin Sans FB Demi', sans-serif;
                                                 font-weight: bold; color: black; font-size: 11px;">( ) Identification</h5>
                                             <h5 class="text-uppercase" style="font-family: 'Berlin Sans FB Demi', sans-serif;
                                                 font-weight: bold; color: black; font-size: 11px;">( ) Employment</h5>    
                                            </div>
                                            <div class="text-center">
                                                <h2 style="font-family: 'Bookman Old Style', sans-serif;
                                                 color: black; font-size:12px;" class="mt-5">Issued this <?= date("F j, Y") ?>
                                            </h2> 
                                            </div>

                                            <div class="text-center mt-5">
                                                <span class="fw-bold text-uppercase" style="color: black; font-family: 'Times New Roman', sans-serif; text-decoration: underline; font-size:15px; margin-left: 70px;"><?= ucwords($resident['firstname'].' '.$resident['middlename'].'. '.$resident['lastname']) ?></span> 
                                            </div>

                                            <div class="float-start">
                                                <h5 style="color: black; font-size: 14px;">Signature</h5>
                                            </div>
