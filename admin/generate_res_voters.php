...
$id = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
    ...
    $query = $conn->prepare("SELECT * FROM resident LEFT JOIN purok ON purok.purok = resident.purok WHERE purok_id =:id AND voters_status = 'yes' AND delete_status != 'Archive'");
...
@import url('http://fonts.cdnfonts.com/css/bookman-old-style');
 ...
 <main id="main" class="main">
    <div class="pagetitle">
      <h1>Resident Voter's List in <?= $purok ?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item active">Resident Voter's List in <?= $purok ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="row mt-2">
                <div class="col-12">
                  ...
                  <table class="table text-center">
                    <p class="mb-0 text-dark text-sm">List of Voter's Resident in <?=$purok?></p>
