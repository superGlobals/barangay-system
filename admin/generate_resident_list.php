...
require 'include/sidebar.php';
    $query = $conn->prepare("SELECT * FROM resident WHERE delete_status != 'Archive'");
    $query->execute();
              ...
              <div class="row mt-2">
                <div class="col-12">
                  ...
                  <table class="table text-center">
                    <p class="mb-0 text-dark text-sm">List of Resident</p>
                  ...
                  <thead>
                   ...
                   <tbody>
                    ...
                    $query = $conn->prepare("SELECT * FROM resident LEFT JOIN purok ON purok.purok = resident.purok WHERE delete_status !='Archive' ORDER BY purok_id ASC");
                    $query->execute();
                    $result = $query->fetchAll(PDO::FETCH_ASSOC);
                    foreach($result as $row):
