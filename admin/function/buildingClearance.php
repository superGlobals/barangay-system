                                        ...
                                        <div class="col-4" >
                                            <div class="text-center p-3" style="border-right:4px solid black;">
                                             <!--    <img src="../<?php echo $row['brgy_logo'] ?>" class="img-fluid" width="100"> -->
                                               ...
                                               <h5 style="font-weight: bold; color: black; font-size: 17px; " class="mb-0 text-uppercase"><?php echo $captain['firstname']." ". $captain['middlename']." ". $captain['lastname']?></h5>
                                             <h5 style="color: black; font-size: 11px; " class="mb-2 text-uppercase"><?php echo $captain['chairmanship'] ?></h5>
                                                <h5 style="font-weight: bold; color: black; font-size: 17px; " class="mb-0 text-uppercase"><?php echo $sec['firstname']." ". $sec['middlename']." ". $sec['lastname']?></h5>
                                             <h5 style="color: black; font-size: 11px; " class="mb-2 text-uppercase"><?php echo $sec['position'] ?></h5>
                                             <h5 style="font-weight: bold; color: black; font-size: 17px; " class="mb-0 text-uppercase"><?php echo $t['firstname']." ". $t['middlename']." ". $t['lastname']?></h5>
                                             <h5 style="color: black; font-size: 11px; " class="mb-2 text-uppercase"><?php echo $t['position'] ?></h5>
                                            ...
                                            <?php if(!empty($officials)):?>
                                                    <?php foreach($officials as $row): ?>
                                                        ...
                                                        <h5 style="font-weight: bold; color: black; font-size: 17px; " class="mt-4 mb-0 text-uppercase"><?= ucwords($row['firstname']." ". $row['middlename']." ". $row['lastname']) ?></h5>
                                                        <h5 style="font-weight: bold; color: black; font-size: 12px; " class="fw-bold mb-0 text-uppercase"><?= ucwords($row['chairmanship']) ?></h5>
                                             ...
                                             <h5 style="color: black; font-size: 11px; " class="mb-2 text-uppercase"><?php echo $skk['position'] ?></h5>
                                            </div>
                                        </div>
                                        <div class="col-8" >
                                            <div class="text-center">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="function/walkin_requestFuntion.php" >
                                ...
                                <label><i class="fa-solid fa-wallet"></i> Payment Per copy is <i class="fa-solid fa-peso-sign"></i><?php echo $buildingPrice['building_price'] ?></label>
