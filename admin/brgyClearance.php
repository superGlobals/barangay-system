...
@import url('http://fonts.cdnfonts.com/css/bookman-old-style');
 ...
 <main id="main" class="main">
    ...
    <?php if($bayad['clearance_price'] == 0): ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="function/walkin_requestFuntion.php" >
                        ...
                        <label><i class="fa-solid fa-wallet"></i> Payment Per copy is <i class="fa-solid fa-peso-sign"></i><?php echo $bayad['clearance_price'] ?></label>
                        <input type="hidden" class="form-control" name="amount" value="<?php echo $bayad['clearance_price'] ?>">
                        </div>
                </div>
                <div class="modal-footer">
                    <input type="hidden" class="form-control" name="resident_id" value="<?php echo $resident['resident_id'] ?>">
                    <input type="hidden" name="resident_name" value="<?= $resident['firstname']." ".$resident['lastname'] ?>">
                    
                    <button type="button" class="btn btn-secondary" onclick="goBack()">Close</button>
                    <button type="submit" name="brgyClearance" class="btn btn-primary">Save</button>
                </div>
                </form>
            </div>
        </div>
