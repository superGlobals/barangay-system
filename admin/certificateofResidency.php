...
<?php if($bayad['residency_price'] == 0): ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="function/walkin_requestFuntion.php" >
                                ...
                                <label><i class="fa-solid fa-wallet"></i> Payment Per copy is <i class="fa-solid fa-peso-sign"></i><?php echo $bayad['residency_price'] ?></label>
                                <input type="hidden" class="form-control" name="amount" value="<?php echo $bayad['residency_price'] ?>">
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="brgyResidency" class="btn btn-primary">Save</button>
                        </div>
                        </form>
                    </div>
                </div>
