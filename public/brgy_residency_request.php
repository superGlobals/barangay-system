      ...
      <div class="container" data-aos="fade-up">
        <div class="card-haha maangas">
          <div class="section-title">
            <h5 class="h5-title text-center pb-0 fs-3">Barangay Residency</h5>
            <p class="text-center">A Barangay Certificate or Barangay Certificate of Residency is a government-issued document in the Philippines. It can be obtained from the local government office of the individual's place of residence. It is issued by the Barangay Secretary and signed by the Barangay Captain.</p>
          </div>
          ...
          <div class="row mt-5">
            ...
            <div class="col-lg-4">
              <div class="info">
                <div class="address">
                  ...
                  <?php if ($fees['residency_price'] == 0): ?>
                  <h4>Fees: Free</h4>
                  <?php else: ?>
                    <h4>Fees: <?= $fees['residency_price'] ?></h4>
                  <?php endif; ?>
                </div>
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <form action="transactionFunction.php" method="post">
                <input type="hidden" name="residency_price" value="<?= $fees['residency_price'] ?>">
                <div class="row">
                ...
                <?php if(isset($_SESSION['unique_id'])): ?>
                <div class="text-center"><button type="submit" name="brgyResidency">Submit</button></div>
              <?php endif; ?>
              </form>
