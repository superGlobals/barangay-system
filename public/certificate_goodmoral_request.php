      ...
      <div class="container" data-aos="fade-up">
        <div class="card-haha maangas">
          <div class="section-title">
            <h5 class="h5-title text-center pb-0 fs-3">Certificate of Good Moral</h5>
          </div>
          ...
          <div class="row mt-5">
            ...
            <div class="col-lg-4">
              <div class="info">
                <div class="address">
                  ...
                  <?php if ($fees['goodmoral_price'] == 0): ?>
                  <h4>Fees: Free</h4>
                  <?php else: ?>
                    <h4>Fees: <?= $fees['goodmoral_price'] ?></h4>
                  <?php endif; ?>
                </div>
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
              ...
              <form action="transactionFunction.php" method="post">
                <input type="hidden" name="goodmoral_price" value="<?= $fees['goodmoral_price'] ?>">
                <div class="row">
                ...
                <div class="form-group mt-3">
                 ...
                 <?php if(isset($_SESSION['unique_id'])): ?>
                <div class="text-center"><button type="submit" name="brgyGoodMoral">Submit</button></div>
              <?php endif; ?>
              </form>
